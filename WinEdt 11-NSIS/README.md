# WinEdt 11.2 KVicTools

Эта программа является надстройкой над программой WinEdt 11.2, добавляющей к ней русский интерфейс и ряд сервисных функций, направленных на облегчение работы с документами в формате TeX.
...
Для просмотра PDF файлов по умолчанию в WinEdt 11.2 используется программа WinEdtPDF, обладающая возможностью прямого и обратного поиска между TEX документами и их PDF образами.
...
На вопросы, касающиеся **WinEdt 11.2 KVicTools**, Вам по возможности ответит [Victor Kozyakin](mailto:victor.kozyakin@yandex.ru)

---

This program is an add-on for the WinEdt 11.2 program, supplementing it with a Russian interface and a set of service functions designed to facilitate work with TeX documents.
...
For viewing PDF files WinEdt 11.2 uses WinEdtPDF, which offers the ability to search forward and backward between TEX documents and their PDF images.
...
Questions about **WinEdt 11.2 KVicTools** will be answered by [Victor Kozyakin](mailto:victor.kozyakin@yandex.ru).
